...
<head>
    ...
    <title>أوركا | إنشاء حساب جديد</title>
...
<body>
    ...
    <div class="auth-container">
        ...
        <div class="subtitle">لديك حساب بالفعل؟ <a href="{{ route('login') }}">تسجيل الدخول من هنا</a></div>
        ...
        <form action="#" method="POST" id="registerForm">
            ...
            <div class="form-group-row">
                <div class="form-group">
                    ...
                    <input type="text" id="name" placeholder="محمد أحمد" required autocomplete="name">
                </div>
                <div class="form-group">
                    <label for="org">المنظمة / الشركة</label>
                    <input type="text" id="org" placeholder="شركة مساهمة" required>
                </div>
            </div>
            ...
            <div class="form-group-row">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password_confirmation" placeholder="••••••••" required autocomplete="new-password">
                </div>
            </div>

            <label class="terms-label">
                <input type="checkbox" id="terms" required>
                <span>أوافق على اتفاقية مستوى خدمة أوركا، شروط الخدمة، وسياسة الخصوصية للمؤسسات.</span>
            </label>

            <button type="submit" class="btn-submit">تهيئة بيئة العمل الخاصة بك</button>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#registerForm').on('submit', function(e) {
                ...
                // Show loading state
                $btn.prop('disabled', true).css('opacity', '0.75').text('جاري تهيئة قاعدة بيانات ERP...');
                
                setTimeout(function() {
                    $btn.text('جاري إعداد بيئات العمل السحابية الآمنة...');
                    setTimeout(function() {
                        alert('تم التسجيل التجريبي بنجاح! (تم تعطيل إعادة التوجيه لغرض المعاينة)');
